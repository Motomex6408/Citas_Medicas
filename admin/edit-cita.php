...
try {
    ...
    try {
        ...
        if ($nuevoEstado == 'Confirmada') {
            $mail->Subject = "Confirmación de Cita - Proceder al Pago";
            $enlacePago = "http://localhost/Citas_Medicas/Pacientes/Pago.php?id=" . urlencode(base64_encode($idCita));
            $mail->Body = "
                ...
                <p>Para completar el proceso, por favor realice el pago:</p>
                <p><a href='{$enlacePago}' style='background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Pagar Ahora</a></p>
            ";
        } else {
